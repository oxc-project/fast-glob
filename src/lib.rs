...
//! | `[ab]`  | Matches one of the characters contained in the brackets, except path separators. Character ranges, e.g., `[a-z]`, are also supported. Use `[!ab]` or `[^ab]` to match any character _except_ those contained in the brackets. |
